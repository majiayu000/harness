...
pub use eval::{
    ...
    eval_isolated_runtime_profile, eval_report_dry_run, eval_report_from_evidence,
    ...
    parse_historical_replay_cohort_str, score_pr_repair_eval, server_owned_eval_metadata,
    ...
    EvalCommitResolution, EvalEvidenceStatus, EvalExecuteConfig, EvalIsolationEvidence,
    EvalIsolationLifecycle, EvalIsolationProfile, EvalQualityGateEvidence, EvalReportCase,
    ...
    EvalRunReport, EvalRunReportDiff, EvalSubmissionEvidence, EvalVerifyCommandMode,
    HistoricalReplayCase, HistoricalReplayCohort, HistoricalReplayCohortVerdict,
    HistoricalReplayCommandEvidence, HistoricalReplayCommandRun, HistoricalReplayComparison,
    HistoricalReplayError, HistoricalReplayIssueSnapshot, HistoricalReplayPullRequestSnapshot,
