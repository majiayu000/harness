...
pub use eval::{
    ...
    eval_report_from_evidence, eval_run_attestation_payload_digest, evidence_bundle_manifest_json,
    historical_replay_command_digest, parse_benchmark_manifest_str,
    parse_historical_replay_cohort_str, read_evidence_bundle_artifact, score_pr_repair_eval,
    validate_historical_replay_cohort, verify_eval_run_attestation, verify_evidence_bundle,
    write_evidence_bundle, EvalAttestationDecision, EvalAttestationSummary, EvalAttestationTrust,
    EvalAttestationVerificationError, EvalBenchmarkCase, EvalBenchmarkManifest,
    EvalCaseDispatchOutcome, EvalCaseEnqueueOutcome, EvalCaseEvidence,
    ...
    EvalCommitResolution, EvalEvidenceStatus, EvalIsolationEvidence, EvalIsolationLifecycle,
    ...
    EvalRunReportDiff, EvalSubmissionEvidence, EvidenceBundleArtifactInput,
    EvidenceBundleArtifactKind, EvidenceBundleError, EvidenceBundleFileManifest,
    EvidenceBundleManifest, EvidenceBundleRedaction, EvidenceBundleVerification,
    ...
    EVIDENCE_BUNDLE_ARTIFACT_SCHEMA_VERSION, EVIDENCE_BUNDLE_MANIFEST_SCHEMA_VERSION,
    EVIDENCE_BUNDLE_SCHEMA_VERSION, HISTORICAL_REPLAY_COHORT_SCHEMA, REDACTED_VALUE,
};
