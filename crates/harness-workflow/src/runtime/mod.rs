...
pub use eval::{
    ...
    eval_report_from_evidence, eval_report_from_imported_evidence,
    eval_run_attestation_payload_digest, execute_manifest, execute_manifest_with_cancellation,
    execute_trusted_eval_verifier, historical_replay_command_digest, parse_benchmark_manifest_str,
    parse_historical_replay_cohort_str, retry_eval_report_events, server_owned_eval_metadata,
    validate_historical_replay_cohort, verify_eval_run_attestation, EvalAttestationDecision,
    EvalAttestationSummary, EvalAttestationTrust, EvalAttestationVerificationError,
    EvalBenchmarkCase, EvalBenchmarkManifest, EvalCaseEnqueueOutcome, EvalCaseEvidence,
    ...
    EvalCommitResolution, EvalEventPersistenceError, EvalEvidenceStatus, EvalExecuteConfig,
    EvalImportedEvidence, EvalIsolationEvidence, EvalIsolationLifecycle, EvalIsolationProfile,
    EvalQualityGateEvidence, EvalReportCase, EvalReportCaseOutcome, EvalReportCaseStatus,
    EvalReportError, EvalReportFailedGate, EvalReportMetricDelta, EvalReportMetrics,
    EvalRunAttestation, EvalRunAttestationClaims, EvalRunAttestationExpected, EvalRunOutcome,
    EvalRunReport, EvalRunReportDiff, EvalSubmissionEvidence, EvalTrustedVerifier,
    ...
    VerifiedEvalRunAttestation, DEFAULT_CASE_TIMEOUT_SECS, DEFAULT_EVAL_DISPATCH_TIMEOUT,
...
pub use pr_feedback::{
    ...
    FeedbackRepairLane, LocalReviewCompletedInput, LocalReviewDecisionInput, LocalReviewOutcome,
    PrDetectedDecisionInput, PrFeedbackDecisionInput, PrFeedbackDecisionOutput,
