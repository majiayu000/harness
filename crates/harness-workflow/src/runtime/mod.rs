...
pub use eval::{
    ...
    enqueue_eval_case_workflow, eval_benchmark_manifest_digest, eval_benchmark_suite_digest,
    eval_isolated_runtime_profile, eval_report_dry_run, eval_report_from_evidence,
    eval_run_attestation_payload_digest, historical_replay_command_digest,
    parse_benchmark_manifest_str, parse_historical_replay_cohort_str, score_pr_repair_eval,
    ...
    EvalCaseEvidence, EvalCaseInfrastructureStatus, EvalCaseRisk, EvalCaseTransition,
    EvalCaseTransitionCounts, EvalCaseTransitionKind, EvalCaseVerdict, EvalCaseWorkflowInput,
    EvalCaseWorkflowPlan, EvalCommitResolution, EvalEvidenceStatus, EvalIsolationEvidence,
    ...
    EvalRunReport, EvalRunReportDiff, EvalSubmissionEvidence, HistoricalReplayCase,
    ...
    EVAL_BENCHMARK_MANIFEST_SCHEMA_VERSION, EVAL_BRANCH_PREFIX, EVAL_PR_DRAFT_MODE,
