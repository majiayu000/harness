...
pub use eval::{
    ...
    EvalIsolationEvidence, EvalIsolationLifecycle, EvalIsolationProfile, EvalQualityGateEvidence,
    EvalReportCase, EvalReportCaseOutcome, EvalReportCaseStatus, EvalReportError,
    EvalReportFailedGate, EvalReportMetricDelta, EvalReportMetrics, EvalRunAttestation,
    EvalRunAttestationClaims, EvalRunAttestationExpected, EvalRunOutcome, EvalRunReport,
    EvalRunReportDiff, EvalSubmissionEvidence, EvalTrustedVerifier, EvalUsageCeiling,
    EvalValidationCommandEvidence, EvalVerifyCommandMode, HistoricalReplayCase,
...
pub use pr_feedback::{
    ...
    FeedbackRepairStop, LocalReviewCompletedInput, LocalReviewDecisionInput, LocalReviewOutcome,
