...
pub(super) static WORKFLOW_RUNTIME_MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        ...
        sql: "CREATE TABLE IF NOT EXISTS runtime_job_lease_issuances (
              ...
              -- Block old instances from committing a claim or renewal between
              -- the backfill snapshot and trigger installation. The lock is
              -- held until this migration transaction commits.
              LOCK TABLE runtime_jobs IN SHARE ROW EXCLUSIVE MODE;
