...
## [0.6.34](https://github.com/majiayu000/harness/releases/tag/harness-workflow-v0.6.34) - 2026-06-27

### Added

- *(runtime)* summarize workflow projection buckets ([#1404](https://github.com/majiayu000/harness/pull/1404))
...
- *(runtime)* add workflow state registry ([#1398](https://github.com/majiayu000/harness/pull/1398))
- *(runtime)* route stale recovery through decisions ([#1394](https://github.com/majiayu000/harness/pull/1394))
- *(runtime)* transact parent completion propagation ([#1392](https://github.com/majiayu000/harness/pull/1392))
- *(runtime)* scope terminal states by definition ([#1390](https://github.com/majiayu000/harness/pull/1390))
...
- Implement direct autonomous GitHub intake lifecycle ([#1407](https://github.com/majiayu000/harness/pull/1407))
- guard workflow graph references ([#1406](https://github.com/majiayu000/harness/pull/1406))
