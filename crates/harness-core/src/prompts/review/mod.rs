...
pub fn review_prompt(
    ...
    format!(
        "{context}\
         ...
         Record that review's id and body for later cross-referencing. \
         ...
         3b. If the most recent Gemini COMMENTED review from step 2b exists and its review id does not appear \
