//! Review-related prompt builders.
...
mod tests {
    ...
    fn test_malformed_reviewer_output_is_not_approved_and_has_no_issues() {
        // This test exercises the review module's prompt building only.
        // The is_approved / extract_review_issues parsers live in parsers.rs.
        let p = agent_review_prompt("https://github.com/owner/repo/pull/1", 1, "rust");
        assert!(p.contains("APPROVED"));
        assert!(p.contains("ISSUE:"));
    }
