use harness_core::{
    Decision, Event, ProjectId, RemediationType, Signal, SignalThresholdsConfig, SignalType,
    Violation,
};
...
mod tests {
    use super::*;
    use harness_core::{
        Decision, Event, ProjectId, SessionId, Severity, SignalThresholdsConfig, SignalType,
        Violation,
    };
