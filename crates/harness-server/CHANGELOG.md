...
## [0.6.34](https://github.com/majiayu000/harness/releases/tag/harness-server-v0.6.34) - 2026-06-27
...
- *(runtime)* accept structured result with skill warning
- *(storage)* probe legacy workflow tables before migration ([#1402](https://github.com/majiayu000/harness/pull/1402))
- *(runtime)* project worktree status from runtime ([#1396](https://github.com/majiayu000/harness/pull/1396))
...
- Fix startup health wait and runtime summary path ([#1409](https://github.com/majiayu000/harness/pull/1409))
