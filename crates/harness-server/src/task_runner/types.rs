...
pub(super) fn describe_detect_main_worktree_join_error(
...
pub(super) const TRANSIENT_PATTERNS: &[&str] = &[
    "at capacity",
    "rate limit",
    "rate_limit",
    "hit your limit",
...
pub(super) const ACCOUNT_LIMIT_PATTERN: &str = "hit your limit";

/// Maximum number of automatic retries for transient failures.
pub(super) const MAX_TRANSIENT_RETRIES: u32 = 2;
