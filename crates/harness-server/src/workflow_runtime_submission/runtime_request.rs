//! Workflow-runtime submission request model.
...
pub async fn fill_missing_repo_from_project(req: &mut CreateTaskRequest) {
    ...
    req.repo = crate::workflow_runtime_pr_feedback::pr_detection::detect_repo_slug(project).await;
}

/// Detect the main workspace root without launching git.
pub fn detect_main_worktree() -> PathBuf {
