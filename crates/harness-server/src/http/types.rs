...
pub struct CoreServices {
    ...
    pub tasks: Arc<crate::task_runner::TaskStore>,
...
pub struct ObservabilityServices {
    ...
    pub signal_rate_limiter: Arc<super::rate_limit::SignalRateLimiter>,
    pub password_reset_rate_limiter: Arc<super::rate_limit::PasswordResetRateLimiter>,
...
pub struct IntakeServices {
    ...
    pub completion_callback: Option<crate::task_runner::CompletionCallback>,
}
