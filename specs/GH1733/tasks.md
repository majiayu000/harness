...
- [ ] Obtain mandatory human security review of the effective-sandbox
      ...
      protocol; allocation-free post-fork work; pidfd registration,
...
- MCP server identity is derived from a typed exact stable configuration-entry
  ...
  to Draft 2020-12; legacy `definitions`, `dependencies`, tuple `items`, and
  `additionalItems` semantics apply only to Draft-07. Draft-07
  ...
  JSON; and fixed text/annotation/schema limits fail typed under the frozen
