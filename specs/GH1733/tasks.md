...
- [ ] Obtain mandatory human security review of the Unix `execve` pre-exec
      path, including argument/environment pointer ownership, NUL validation,
      errno propagation, and proof that `ENOEXEC` cannot invoke a shell.
